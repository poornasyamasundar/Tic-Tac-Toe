...
opponentFilename = 'opponent'+str(board_layout)+'.txt'
policyFilename = 'policy'+str(board_layout)+'.txt'
line_width = 6
                ...
                if game_over == False:
                        ...
                        if event.type == pygame.MOUSEBUTTONUP and clicked == True:
                                ...
                                if markers[cell_y][cell_x] == 0:
                                        ...
                                        check_game_over()
                                        if game_over == False:
                                                move = getOpponentMove(markers, board_layout)
                                                markers[move[0]][move[1]] = -1
                                        check_game_over()
                                print('pos = '+str(cell_y)+', '+str(cell_x))
                                for i in range(board_layout):
                                        for j in range(board_layout):
                                                print(markers[i][j], end = " ")
                                        print()
